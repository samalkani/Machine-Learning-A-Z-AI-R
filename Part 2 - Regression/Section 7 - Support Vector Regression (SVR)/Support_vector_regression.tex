...
\urlstyle{same}
\hypersetup{
  pdftitle={Support Vector Regression},
...
\hypertarget{reset-dataset}{%
\subsection{Reset dataset}\label{reset-dataset}}
...
\hypertarget{block-1}{%
\subsection{block 1}\label{block-1}}

\hypertarget{block-2}{%
\subsection{block 2}\label{block-2}}

\hypertarget{block-3}{%
\subsection{block 3}\label{block-3}}

\hypertarget{block-4}{%
\subsection{block 4}\label{block-4}}

\hypertarget{block-5}{%
\subsection{block 5}\label{block-5}}
