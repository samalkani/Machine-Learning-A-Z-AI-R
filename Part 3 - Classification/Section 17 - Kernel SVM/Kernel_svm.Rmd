---
title: "Kernel Support Vector Machine (SVM) classification"
...
## Test set results (ground truth) for comparison

```{r Test set results (ground truth)}
test_set$Purchased
