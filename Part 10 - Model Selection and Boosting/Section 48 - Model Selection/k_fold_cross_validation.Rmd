...
cross_fold = as.numeric(cv)
print(paste('K-Fold Accuracies (1 - 10):', cross_fold))
accuracy = mean(as.numeric(cv))
print(paste('average accuracy over 10 folds:', accuracy))
std_dev = sd(as.numeric(cv))
print(paste('average standard deviation over 10 folds:', std_dev))
